...
import com.fasterxml.jackson.databind.ObjectMapper;  // Dodajemy ObjectMapper
...
public class StatsController {
    ...
    @GetMapping("/postęp")
    public String getTasksProgressStats(Model model, HttpSession session) throws JsonProcessingException {
        Map<LocalDate, Long> progressStats = statsService.getTasksCompletedPerDay();

        // Używamy ObjectMapper do konwersji Map na JSON
        ObjectMapper objectMapper = new ObjectMapper();
        String progressStatsJson = objectMapper.writeValueAsString(progressStats);

        // Dodajemy dane JSON do modelu
